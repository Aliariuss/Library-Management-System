    ...
    public partial class InitLibraryDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2024, 7, 31, 20, 34, 0, 38, DateTimeKind.Local).AddTicks(6447), 1, 1, "Monthly" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2024, 7, 31, 20, 34, 0, 38, DateTimeKind.Local).AddTicks(6392), "Late return", 1, 10f });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2024, 7, 31, 20, 34, 0, 38, DateTimeKind.Local).AddTicks(6356), 1, 1, new DateTime(2024, 8, 14, 20, 34, 0, 38, DateTimeKind.Local).AddTicks(6366) });

            migrationBuilder.InsertData(
                table: "Notifications",
                columns: new[] { "NotificationID", "Message", "NotificationDate", "UserID" },
                values: new object[] { 1, "Your book is overdue", new DateTime(2024, 7, 31, 20, 34, 0, 38, DateTimeKind.Local).AddTicks(6407), 1 });

            migrationBuilder.InsertData(
                table: "Reservations",
                columns: new[] { "ReservationID", "BookID", "ReservationDate", "UserID" },
                values: new object[] { 1, 1, new DateTime(2024, 7, 31, 20, 34, 0, 38, DateTimeKind.Local).AddTicks(6420), 1 });
