...
namespace LibraryAutomation.DAL.Migrations
{
    ...
    [Migration("20240731173400_InitLibraryDB")]
            ...
            modelBuilder.Entity("LibraryAutomation.Domain.Loan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            LoanID = 1,
                            BookID = 1,
                            LoanDate = new DateTime(2024, 7, 31, 20, 34, 0, 38, DateTimeKind.Local).AddTicks(6356),
                            MemberID = 1,
                            PenaltyID = 1,
                            ReturnDate = new DateTime(2024, 8, 14, 20, 34, 0, 38, DateTimeKind.Local).AddTicks(6366)
                        });
                });
            ...
            modelBuilder.Entity("LibraryAutomation.Domain.Notification", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NotificationDate = new DateTime(2024, 7, 31, 20, 34, 0, 38, DateTimeKind.Local).AddTicks(6407),
                            UserID = 1
                        });
                });
            ...
            modelBuilder.Entity("LibraryAutomation.Domain.Penalty", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PenaltyID = 1,
                            MemberID = 1,
                            PenaltyDate = new DateTime(2024, 7, 31, 20, 34, 0, 38, DateTimeKind.Local).AddTicks(6392),
            ...
            modelBuilder.Entity("LibraryAutomation.Domain.Report", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ReportID = 1,
                            CreationDate = new DateTime(2024, 7, 31, 20, 34, 0, 38, DateTimeKind.Local).AddTicks(6447),
                            LibraryID = 1,
                            ReportTypeID = 1,
                            Type = "Monthly"
                        });
            ...
            modelBuilder.Entity("LibraryAutomation.Domain.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ReservationID = 1,
                            BookID = 1,
                            ReservationDate = new DateTime(2024, 7, 31, 20, 34, 0, 38, DateTimeKind.Local).AddTicks(6420),
                            UserID = 1
                        });
                });
